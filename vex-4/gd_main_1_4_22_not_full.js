                        ...
                        value: (t = n(regeneratorRuntime.mark(function e() {
                            ...
                            return regeneratorRuntime.wrap(function e(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return t.prev = 0, n = ["https://test-hb.improvedigital.com/pbw/gameDistribution.min.js", "https://hb.improvedigital.com/pbw/gameDistribution.min.js", "http://test-hb.improvedigital.com/pbw/gameDistribution.min.js", "http://hb.improvedigital.com/pbw/gameDistribution.min.js"], r = this.options.debug ? n[0] : n[1], o = (0, p.getScript)(r, "gdsdk_prebid", {
                                            alternates: n
                                        }), window.idhbgd = window.idhbgd || {}, window.idhbgd.que = window.idhbgd.que || [], i = ["https://imasdk.googleapis.com/js/sdkloader/ima3_debug.js", "https://imasdk.googleapis.com/js/sdkloader/ima3.js", "http://imasdk.googleapis.com/js/sdkloader/ima3_debug.js", "http://imasdk.googleapis.com/js/sdkloader/ima3.js"], s = this.options.debug ? i[0] : i[1], t.next = 10, (0, p.getScript)(s, "gdsdk_ima", {
                                            alternates: i,
                                            exists: function e() {
                                ...
                                fetch(t).then(function(e) {
                                    ...
                                    if (e.success) {
                                        ...
                                        r = (0, h.extendDefaults)(r, t), s.msgrt.setGameData(r), (0, _.setDankLog)(r.diagnostic), r.bloc_gard && !0 === r.bloc_gard.enabled ? (s.msgrt.send("blocked"), setTimeout(function() {
                                            document.location = "https://html5.api.gamedistribution.com/blocked.html?domain=".concat((0, h.getParentDomain)())
                        ...
                        value: (n = g(regeneratorRuntime.mark(function e(n) {
                            ...
                            return regeneratorRuntime.wrap(function e(t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 3:
                                        if ((r = t.sent).bloc_gard && !0 === r.bloc_gard.enabled) throw new Error("Game or domain is blocked.");
                                        t.next = 6;
                                        break;
                                    case 6:
